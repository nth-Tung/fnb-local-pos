    ...
    public class StaffService
    {
        ...
        public bool AddStaff(StaffDTO staffDTO)
        {
            ...
            var staff = new Staff
            {
                ...
                Sex = (POS.Entities.Sex)staffDTO.Sex,
                Role = (POS.Entities.StaffRole)staffDTO.Role,
                Phone = staffDTO.Phone,
                Email = staffDTO.Email,
                Shift = (POS.Entities.Shift)staffDTO.Shift,
        ...
        public bool UpdateStaff(StaffDTO staffDTO)
        {
            ...
            existingStaff.Sex = (POS.Entities.Sex)staffDTO.Sex;
            existingStaff.Role = (POS.Entities.StaffRole)staffDTO.Role;
            existingStaff.Phone = staffDTO.Phone;
            existingStaff.Email = staffDTO.Email;
            existingStaff.Shift = (POS.Entities.Shift)staffDTO.Shift;
